...
public class Drivetrain extends Subsystem{
	...
	//Metric version of this function  *** NOT DONE ***
	public double controllerOutputMetric(double accel, double velocity) {
		outputVoltage = (this.mass*accel/12*wheelRadius*this.R/(gearRatio*this.kt))/this.nMotors + // I*R term    "acceleration"
				velocity*(60)*gearRatio/(this.kv*2*Math.PI*wheelRadius);                           // W/kv term  "velocity"
	...
	public void trapezoidalV2(double dist) {
		distance = dist;
		double specifiedAcceleration = 40.0;   //Nice linear at 150 in/s/s
		double specifiedVelocity = 40.0;       //Nice linear at 120 in/s
	...
	/*
	Method to start at 0 velocity, ending at target velocity using specified acceleration
	*/
	public void linearAccelSegment(double acc, double velFinal) {  
